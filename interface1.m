...
% Last Modified by GUIDE v2.5 09-Mar-2023 04:14:29
...
set(handles.text2,'string',num2str(rows));
set(handles.text3,'string',num2str(columns));
...
rotaion=str2double(get(hObject,'string'));
...
% handles    structure with handles and user data (see GUIDATA)
global image
rotaion=str2double(get(handles.edit4,'string'));
Rot=imrotate(image,rotaion);
axes(handles.axes2);
imshow(Rot);


function edit5_Callback(hObject, eventdata, handles)
profil_ligne=str2double(get(hObject,'string'));
...
profil_colonne=str2double(get(hObject,'string'));
...
% handles    structure with handles and user data (see GUIDATA)
global image
profil_ligne=str2double(get(handles.edit5,'string'));
profil_Lig=image(profil_ligne,:);
axes(handles.axes2);
plot(profil_Lig);


function edit7_Callback(hObject, eventdata, handles)
coupe1=str2double(get(hObject,'string'));
...
coupe2=str2double(get(hObject,'string'));
...
coupe3=str2double(get(hObject,'string'));
...
coupe4=str2double(get(hObject,'string'));
...
% handles    structure with handles and user data (see GUIDATA)
global image
coupe1=str2double(get(handles.edit7,'string'));
coupe2=str2double(get(handles.edit8,'string'));
coupe3=str2double(get(handles.edit9,'string'));
coupe4=str2double(get(handles.edit10,'string'));
for i=coupe1:coupe2
     for j=coupe3:coupe4
      coupe(i,j)=image(i,j);
     end;
...
% handles    structure with handles and user data (see GUIDATA)
global image
profil_colonne=str2double(get(handles.edit6,'string'));
profil_col=image(:,profil_colonne);
axes(handles.axes2);
plot(profil_col);
